...
export default function CityProductsSection({
  citySlug,
  cityName,
}: {
  citySlug: string
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
                ...
                <div className="h-full glass-enhanced rounded-2xl p-6 sm:p-8 border border-gold/20 hover:border-gold/50 transition-all cursor-pointer group">
                  <div className="flex justify-center items-center gap-4">
                    <div>
                      ...
                      <p className="text-gray-400 mb-2 text-sm sm:text-base">{product.description}</p>
                      <p className="text-gray-500 text-xs sm:text-sm">{product.extraLine}</p>
                    </div>
        ...
        {/* Why Choose Section */}
        <div className="mt-12 sm:mt-16 glass-enhanced rounded-2xl p-6 sm:p-8 border border-gold/20">
          ...
          <p className="text-center text-gray-500 text-xs sm:text-sm mt-6">
            On-time luxury setup across {cityName} • Instant prints • Trained team on-site
          </p>
        </div>
      </div>
    </SectionWrapper>
